...
ax.plot_surface(x,y,zs, color = "green",alpha = 0.8)
...
ax.add_artist(d)
ax.add_artist(f)
ax.set_xlim([-(x2t+ 20),(x2t+ 20)])
ax.set_ylim([-(x2t+ 20),(x2t+ 20)])

ax1.plot_surface(x,y,z, color = "white", alpha = 0.6)
ax1.plot_surface(x,y,zs, color = "green",alpha = 0.8)
ax1.plot_surface(bx,by,zs, color = "green",alpha = 0.2)
ax1.scatter(xc,yc,zc, color = "red", marker = ".",linewidths = 0.3)
ax1.scatter(origin[0],origin[1],origin[2], cmap = "Blacks", marker = "o", linewidths =1)
ax1.scatter(origin[0],origin[1],0, cmap = "Blacks", marker = "o", linewidths =1)
ax1.set_xlim([-(x2t+ 20),(x2t+ 20)])
ax1.set_ylim([-(x2t+ 20),(x2t+ 20)])

ax2.plot_surface(x,y,z, color = "white", alpha = 0.6)
ax2.plot_surface(x,y,zs, color = "green",alpha = 0.8)
ax2.plot_surface(bx,by,zs, color = "green",alpha = 0.2)
ax2.scatter(xc,yc,zc, color = "red", marker = ".",linewidths = 0.3)
ax2.scatter(origin[0],origin[1],origin[2], cmap = "Blacks", marker = "o", linewidths =1)
ax2.scatter(origin[0],origin[1],0, cmap = "Blacks", marker = "o", linewidths =1)
ax2.set_xlim([-(x2t+ 20),(x2t+ 20)])
ax2.set_ylim([-(x2t+ 20),(x2t+ 20)])